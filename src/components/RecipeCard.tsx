...
const RecipeCard = ({ recipe }: RecipeCardProps) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md border border-neutral-200 overflow-hidden transition-shadow duration-200 max-w-sm mx-auto">
      <div className="relative w-45 h-48 bg-neutral-100">
        <Image
